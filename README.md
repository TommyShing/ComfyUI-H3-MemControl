...
|---|---|---|---|
| `H3MemControlSetup` | `model: MODEL`, `clip: CLIP?`, `vae: VAE?`, `audio_vae: VAE?` | same objects | Register H3 and qwen block scheduling and VAE cache |
| `H3MemControlCleanup` | `passthrough: ANY`, `stage: COMBO` | `passthrough: ANY` | Release managed block state; does not clear user IO |
